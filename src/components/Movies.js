...
function Movies() {
  return (
    <Container>
      ...
      <Content>
        <Wrap>
          <img src="https://prod-ripcut-delivery.disney-plus.net/v1/variant/disney/90909C6C78C1833D199545FB21F7E3CCFBB091B5E22B66DB393A4190CEFC3533/scale?width=800&aspectRatio=1.78&format=jpeg" />
        </Wrap>
        <Wrap>
